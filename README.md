...
| Stage | Approach |
|-------|----------|
| Confirmatory | Logistic regression across 5 model specifications with clustered standard errors |
| Predictive | Random Forest and XGBoost with 5-fold cross-validation |
| Feature importance | Permutation-based ranking to identify dominant return predictors |
